...
function statsSvg(theme, data) {
  ...
  <circle cx="495" cy="63" r="38" fill="${c.track}"/><text x="495" y="72" text-anchor="middle" fill="${c.accent}" font-family="ui-monospace,SFMono-Regular,Menlo,monospace" font-size="27" font-weight="700">${data.rank.level}</text><text x="495" y="107" text-anchor="middle" fill="${c.muted}" font-family="-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif" font-size="11" font-weight="600">Activity Grade</text><text x="495" y="122" text-anchor="middle" fill="${c.muted}" font-family="-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif" font-size="9">top ${data.rank.percentile.toFixed(1)}%</text>
  ...
  <text x="532" y="231" text-anchor="end" fill="${c.muted}" font-family="ui-monospace,SFMono-Regular,Menlo,monospace" font-size="10">Activity Grade · github-readme-stats</text>
</svg>`;
}
